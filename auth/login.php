...
if (isset($_POST['login'])) {
    ...
    if (
        ...
        if (
            ...
            $_SESSION['program_studi_id'] = $user['program_studi_id'];
...
<section class="min-h-screen flex flex-col md:items-center justify-center mt-5 py-20">
    ...
    <div
        ...
        <p class="text-sm md:text-base">
            Silahkan masuk untuk reservasi lab
        </p>
        ...
        <form method="POST" class="w-full flex flex-col gap-7">
            ...
            <div class="flex justify-between">
                <label class="flex items-center gap-2 text-[#767676]">
                ...
                <a href="../?page=lupa_password" class="text-blue-500 hover:opacity-70">Lupa kata sandi?</a>
            </div>
            <div class="flex flex-col gap-3.75">
                ...
                <div class="flex items-center w-full max-w-md">
                    ...
                    <span class="px-4 text-[#8C8C8C] font-medium">Tidak Punya Akun?</span>
