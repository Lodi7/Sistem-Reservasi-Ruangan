...
<section class="
        py-15
        mt-18
        px-5 sm:px-15 md:px-25
    ">

    <!-- Content -->
    <div class="flex flex-col gap-5 md:gap-7.25">
        <!-- image      -->
        <div class="relative">
            <img src="<?= $lab['gambar']; ?>" alt="<?= $lab['nama_lab']; ?>" class="
                    w-full
                    md:h-110
                    h-50
                    object-cover
            ...
            <span class="
absolute top-3 right-3 px-3.75 py-1.25 font-semibold text-xs md:text-[13px] rounded-xl text-center
                        <?=
                            $lab['status'] == 'Tersedia'
            ...
            <div class="
                ...
                <div>
                    ...
                    <p class="
                        ...
                        <?= substr($lab['jam_buka'], 0, 5); ?>
                        -
                        <?= substr($lab['jam_tutup'], 0, 5); ?>
                        WIB
                    </p>
            ...
            <div class="
                ...
                <div class="
                    ...
                    <?php foreach (
                        ...
                        <span class="
                               font-light text-sm md:text-base border-2 text-center hover:bg-[#FF925C] hover:text-white hover:-translate-y-0.5 transition duration-300 border-[#FF925C] rounded-full px-3 py-1
                            ">
        ...
        <?php if (isset($_SESSION['is_login'])): ?>
            <a href="index.php?page=ajukan_reservasi" class="w-full p-2 flex justify-center items-center text-center rounded-full font-semibold text-base md:text-xl text-white <?= $lab['status'] == 'Tersedia'
            ...
            <a href="index.php?page=login" class="w-full p-2 flex justify-center items-center text-center rounded-full font-semibold text-base md:text-xl text-white <?= $lab['status'] == 'Tersedia'
                ? 'bg-[#FF925C] cursor-pointer'
                : 'bg-gray-300 cursor-not-allowed pointer-events-none' ?>">
        ...
        <?php endif; ?>
        <a href="index.php?page=jadwal_lab"
            class="w-full p-2 flex justify-center items-center text-center rounded-full font-semibold text-base md:text-xl text-black border border-[#FF925C] 
        <?= $lab['status'] == 'Tersedia' ? 'cursor-pointer hover:bg-[#FF925C] hover:text-white' : 'cursor-not-allowed pointer-events-none' ?>">
            Lihat Jadwal
        </a>
